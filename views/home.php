...
?>
<div class="line">
    <div class="card text-center shadow" style="width: 20rem;" <?php if (Application::$app->user && Application::$app->user->isRole() === Need::ROLE_ADMIN): ?>onclick="window.location.href='/adminUsersview'" <?php endif; ?>>
