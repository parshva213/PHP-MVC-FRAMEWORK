...
$app->router->get('/givePermission', [SiteController::class, 'givePermission']);
$app->router->post('/giveAccess', [SiteController::class, 'giveAccess']);
$app->router->get('/usersview', [SiteController::class, 'userview']);
$app->run();
