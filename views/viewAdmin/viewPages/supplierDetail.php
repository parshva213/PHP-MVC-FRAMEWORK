...
<div class="d-grid gap-5">
    ...
    <!-- company details -->
    <div class="company-view d-flex flex-column">
        <a href="/addSupplierCompany?uid=<?= htmlspecialchars($supplier['uid']) ?>" role="button" class="btn btn-primary ms-auto"><span class="bi bi-plus"></span>Add Company</a>
